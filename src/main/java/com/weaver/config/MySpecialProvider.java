...
public class MySpecialProvider extends MapperTemplate {
     ...
     * @param ms
     */
    public String batchInsertListAutoGenerated(MappedStatement ms) {
        return commonBatchInsert(ms, true);
    }
    ...
    public String batchInsertList(MappedStatement ms) {
        return commonBatchInsert(ms, false);
    }

    private String commonBatchInsert(MappedStatement ms, boolean autoGenerated) {
        ...
        sql.append(SqlHelper.insertColumns(entityClass, autoGenerated, false, false));
        sql.append(" VALUES ");
